...
const HowItWorksSection = ({ sectionTitle = "How It Works", steps = [] }) => {
  return (
    <motion.section
    ...
    >
      <div className="max-w-7xl w-full mx-auto flex flex-col">
        <motion.h2
          className="text-[#7F7F7F] mb-6 md:mb-8 lg:mb-10 font-bold leading-tight text-center text-h2"
          variants={fadeIn}
        >
          {sectionTitle}
        </motion.h2>
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              ...
              <p className="text-[#7F7F7F] font-light leading-relaxed md:leading-normal pt-1 md:pt-2 text-body">
                {step}
              </p>
            </motion.div>
          ))}
