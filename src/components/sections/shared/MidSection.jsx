  ...
  return (
    ...
    >
      ...
      <div className="grow shrink w-[415px] basis-auto max-md:hidden">
        <div className="text-white font-[400] leading-[110%] text-h3">
          {title}
        </div>
        <span className="text-white font-[200] block mt-2 text-body">
          {description}
        </span>
      </div>
      ...
      <div className="hidden max-md:block max-md:w-full">
        <div className="text-white font-[500] leading-[110%] text-h3">
          {title}
        </div>
        <span className="text-white font-[200] block mt-2 text-body">
          {description}
  ...
  return (
    ...
    ${
      ...
      >
        ...
        >
          <motion.h2
            className="text-h2 text-white ml-0 font-bold text-center md:text-left mb-8"
            variants={itemVariants}
          >
            {sectionTitle}
          </motion.h2>
