...
const buttonStyles =
  "text-base md:text-lg font-normal text-center leading-none px-6 md:px-9 py-[16px] rounded-[31px] border-[#7F7F7F] border-solid border-2 hover:bg-[rgba(127,127,127,0.1)] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[rgba(127,127,127,0.3)]";
const mobileButtonStyles =
  "w-64 text-base md:text-lg font-normal text-center leading-none px-6 md:px-9 py-[16px] rounded-[31px] border-[#7F7F7F] border-solid border-2 hover:bg-[rgba(127,127,127,0.1)] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[rgba(127,127,127,0.3)]";
  ...
  return (
    <div className="bg-white">
      ...
      <div className="text-center mb-5 p-5">
        <h1 className="font-bold text-gray-500 text-h2">Models</h1>
        <h2 className="font-medium text-gray-500 text-h3">
          {title} {subtitle}
        </h2>
      </div>
                ...
                <div className="mb-4 relative w-full">
                  ...
                  <div className="w-full h-64 bg-white rounded-xl relative overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="font-bold text-white drop-shadow-md mb-1 text-h3">
                        {model.model}
                      </span>
                      <h2 className="font-bold text-white drop-shadow-md rounded-xl text-h3">
                        {model.power}
                      </h2>
                    </div>
                  </div>
              ...
              <div className="px-4 pb-8">
                {specifications.map((specSection, sectionIndex) => (
                  <div key={sectionIndex} className="mb-6">
                    ...
                    <h3 className="text-[#7F7F7F] font-medium mb-3 text-body">
          ...
          <thead>
            <tr>
              <th
                ...
                className="text-center pt-6 pb-4 border-t-0"
              >
                <h1 className="font-semibold text-gray-500 text-h2">Models</h1>
              </th>
            </tr>
            ...
            <tr>
              <th className="text-left align-middle">
                <div className="h-48 flex flex-col justify-center pr-8 pl-6">
                  <h1 className="font-semibold text-gray-500 mb-2 text-h2">
                    {title}
                  </h1>
                  <h2 className="font-medium text-gray-500 text-body">
                    {subtitle}
                  </h2>
                </div>
              </th>
            ...
            {specifications.map((specSection, sectionIndex) => (
              <React.Fragment key={sectionIndex}>
                ...
                <tr>
                  <td
                    colSpan={chargerModels.length + 1}
                    className="py-4 text-left pl-6 pr-8 text-[#7F7F7F] text-base font-bold"
                  >
                    {specSection.category}
                  </td>
                </tr>
