...
export const ChargerComponent = ({ 
  ...
  const handleDownload = (url, fileName) => {
    ...
    link.href = url;
    link.download = fileName || `${title.toLowerCase().replace(/\s+/g, '-')}-specifications.pdf`;
    ...
    return (
      <div className="bg-white">
        ...
        <div className="text-center mb-5 p-5">
          ...
          <h2 className="text-xl font-medium text-gray-500">{title} {subtitle}</h2>
        </div>
            ...
            {showButton && (
              ...
              >
                <button 
                  ...
                  onClick={() => handleDownload(pdfUrl, `${title}-${subtitle}-specifications.pdf`)}
                >
                  {buttonText}
                </button>
              </motion.div>
            ...
            {showButton2 && (
              ...
              >
                <button 
                  ...
                  onClick={() => handleDownload(pdfUrl2, `${title}-installation-guide.pdf`)}
                >
                  {buttonText2}
                </button>
              </motion.div>
              ...
              <tr>
                <th className="text-left align-middle">
                  <div className="h-60 flex flex-col justify-center pr-8 ml-18">
                    <h1 className="text-3xl font-bold text-gray-500 mb-2">{title}</h1>
                    <h2 className="text-2xl font-medium text-gray-500">{subtitle}</h2>
                  </div>
                </th>
