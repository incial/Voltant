...
const WhoAreWe = () => {
  ...
  return (
    <div className='bg-white min-h-screen'>
      ...
      <div
        className='relative w-full h-[300px] sm:h-[400px] md:h-[507px] flex items-center justify-center'
        style={{
      ...
      >
        ...
        {/* Title */}
        <h1 className='relative z-10 text-[28px] sm:text-[32px] md:text-[40px] lg:text-[48px] font-bold text-white text-center px-4 sm:px-6 md:px-8'>
          Who We Are
        </h1>
      </div>
      {/* Logo Section */}
      ...
      <div className='w-full flex flex-col items-center gap-[25px] sm:gap-[40px] md:gap-[60px] lg:gap-[80px] py-8 sm:py-10 md:py-14 lg:py-16 px-4 sm:px-6'>
        ...
        <div className='flex flex-row justify-center items-center gap-[20px] sm:gap-[30px] md:gap-[40px] lg:gap-[50px] flex-wrap'>
          ...
          >
            <FaInstagram size={24} className='w-5 h-5 sm:w-6 sm:h-6' />
          </a>
          <a
            ...
            aria-label='Facebook'
          >
            <FaFacebookF size={24} className='w-5 h-5 sm:w-6 sm:h-6' />
          </a>
          <a
            ...
            aria-label='LinkedIn'
          >
            <FaLinkedinIn size={24} className='w-5 h-5 sm:w-6 sm:h-6' />
          </a>
          <a
            ...
            aria-label='Twitter'
          >
            <FaXTwitter size={24} className='w-5 h-5 sm:w-6 sm:h-6' />
          </a>
        </div>
        <RecentWorks />
      </div>
