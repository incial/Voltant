            ...
            <div className='text-white items-start'>
              ...
              >
                <p className='mb-4 text-sm font-normal leading-relaxed'>
                  A Sustainable Energy start up focused on providing innovative
                  products & advanced technological solutions for industrial &
                  commercial establishments
                </p>

                <p className='mb-4 text-sm font-normal leading-relaxed'>
                  At Voltant Energy, we're shaping a net-zero future with smart,
                  sustainable solutions. Our advanced anaerobic digestion
                  technology turns organic waste into clean energy, fueling a
                  circular economy while reducing environmental impact.
                </p>

                <p className='mb-4 text-sm font-normal leading-relaxed'>
                  From feasibility studies and regulatory approvals to
                  full-scale biogas plant installation and maintenance, we
                  deliver end-to-end waste-to-energy solutions tailored to every
                  need.
                </p>

                <p className='mb-4 text-sm font-normal leading-relaxed'>
                  Our Smart Energy Monitoring systems bring real-time insights,
                  helping businesses cut energy costs, boost efficiency, and
