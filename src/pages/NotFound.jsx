      ...
      <div className="max-w-4xl w-full flex flex-col items-center text-center">
        ...
        <div className="w-full max-w-xs sm:max-w-md mb-8 sm:mb-10 relative">
          ...
          >
            ...
            <motion.rect x="50" y="160" width="60" height="8" rx="4" fill="#4AB757" opacity="0.7" custom={0} variants={searchResultsVariants} />
            <motion.rect x="50" y="175" width="120" height="8" rx="4" fill="#4AB757" opacity="0.5" custom={1} variants={searchResultsVariants} />
            <motion.rect x="50" y="190" width="90" height="8" rx="4" fill="#4AB757" opacity="0.3" custom={2} variants={searchResultsVariants} />

            {/* Document icon with cross */}
            <g transform="translate(220, 160)">
              <motion.g variants={documentVariants}>
                <rect x="0" y="0" width="30" height="40" rx="3" fill="none" stroke="#4AB757" strokeWidth="2" />
                <line x1="7" y1="10" x2="23" y2="10" stroke="#4AB757" strokeWidth="2" />
                <line x1="7" y1="17" x2="23" y2="17" stroke="#4AB757" strokeWidth="2" />
                <line x1="7" y1="24" x2="15" y2="24" stroke="#4AB757" strokeWidth="2" />
              </motion.g>
              <motion.g variants={crossVariants}>
                <line x1="5" y1="5" x2="25" y2="35" stroke="#FF5555" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="25" y1="5" x2="5" y2="35" stroke="#FF5555" strokeWidth="2.5" strokeLinecap="round" />
              </motion.g>
            </g>
